...
//add another non-zero row to the current row to do row operation if row pivot is zero
...
//rows except colId row are subtracted by corresponding coefficient
...
//translate the input matrix to augmented matrix 
...
//does gaussian elimination on each row of matrix
